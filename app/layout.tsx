...
export const metadata: Metadata = {
  ...
  keywords: ['M-Pesa fees', 'Kenya transfer', 'logbook transfer', 'stamp duty Kenya', 'remittance Kenya', 'bank transfer fees'],
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              <div className="md:col-span-2">
                ...
                <p className="text-stone-400 text-sm max-w-md">
                  Kenya's comprehensive transfer calculator hub. Calculate fees for M-Pesa, bank transfers, remittances, vehicle transfers, property transfers, and more.
                </p>
              </div>
              <div>
